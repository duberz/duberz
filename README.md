...
| User AI session hours | 0.0h | 5.6h | 5.6h | 5.6h |
| AI worker hours | 0.0h | 0.0h | 0.0h | 0.0h |
| AI concurrency hours | 0.3h | 10.8h | 10.8h | 10.8h |
...
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 2,109 | 2K | 793K | 422.2M | $1,278.73 | $5,700.08 | $0.00 |
| **Total** | **2,109** | **2K** | **793K** | **422.2M** | **$1,278.73** | **$5,700.08** | **$0.00** |

_454.2M total tokens processed. 92.9% cache hit rate._

_$5,700.08 total saved ($5,700.08 caching + $0.00 model routing vs all-Opus)._
...
| Model | Requests | Input | Output | Cache read | API Cost | Cache savings | Model savings |
| --- | ---: | ---: | ---: | ---: | ---: | ---: | ---: |
| claude-opus-4-6 | 7,712 | 9K | 3.1M | 1,669.3M | $2,740.34 | $22,536.18 | $0.00 |
| claude-sonnet-4-6 | 5,029 | 5K | 1.0M | 312.8M | $110.35 | $844.73 | $441.47 |
| claude-opus-4-5 | 2 | 2 | 182 | 35K | $0.06 | $0.47 | $0.00 |
| **Total** | **12,743** | **15K** | **4.2M** | **1,982.2M** | **$2,850.75** | **$23,381.39** | **$441.47** |

_2,198.5M total tokens processed. 92.5% cache hit rate._

_$23,822.86 total saved ($23,381.39 caching + $441.47 model routing vs all-Opus)._
