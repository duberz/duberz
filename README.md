...
| **Total** | **7,891** | **1.8M** | **2.3M** | **874.6M** | **$1,978.49** | **$8,332.55** | **$479.16** |

_950.8M total tokens processed. 92% cache hit rate._

_$8,811.71 total saved ($8,332.55 caching + $479.16 model routing vs all-Opus)._
